    ...
    <div className='p-7 h-screen flex flex-col justify-between'>
      <div>
        ...
        <form onSubmit={(e) => submitHandler(e)}>
          ...
          <p className='text-center'>Already have a account? <Link to='/' className='text-blue-600'>Login here</Link>
          </p>
        </form>
      </div>
      <div>
        <p className='text-[10px] leading-tight text-center'>This site is protected by nCAPTCHA and Google Privacy Policy</p>
      </div>
    </div>
  )
}
